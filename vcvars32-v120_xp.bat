...
REM set WindowsSdkDir=C:\Program Files (x86)\Microsoft SDKs\Windows\v7.1A
REM set ExtensionSdkDir=C:\Program Files (x86)\Microsoft SDKs\Windows\v7.1A\ExtensionSDKs
...
set PATH=%ProgramFiles(x86)%\Microsoft Visual Studio 12.0\VC\bin;%ProgramFiles(x86)%\Microsoft SDKs\Windows\7.1A\Bin;%PATH%
